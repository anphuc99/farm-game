...
namespace Views
{
    public class BagLandAction : IBagAction
    {
        ...
        {
            EventManager.Emit(EventConstant.ON_LAND_SELECTED, _bagItem);
        }

        public void OnDeselected()
        {
            EventManager.Emit(EventConstant.ON_LAND_DESELECTED, _bagItem);
        }
